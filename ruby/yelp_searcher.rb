...
class YelpSearcher
  ...
  API_KEY = 'kngVWvIibgxl0k0KC1utRCAcumYTSUt7ByJepi2-KM8GVQmFHlCaH7bHD7b1tTkhJoTO_SZ5tYmNuNScgLho_9UXAGzFMk_XAgyJi-m-KlofptIVz-CsRS-m8EMTX3Yx'
  ...
  when "search"
    ...
    response["businesses"].each {|biz| biz["name"]  if biz["location"]["city"] == 'Damascus'}
  when "lookup"
